    ...
    return (
        <nav style={{ display:'inline-flex', backgroundColor:'#D9594C', position: 'relative', top: 0, width: '100%', height:'56px' , alignContent:'center'}}>
            <div style={{ display:'inline-flex'}}>
                <Link to="/" style={{ textDecoration: 'none', color:'white', display:'block', padding:'20px', fontWeight:'bold', textAlign:'center'}}> Home </Link>
                {/* <Link to="/LandingPage" style={{ textDecoration: 'none', color:'white', display:'block', padding:'20px', fontWeight:'bold', textAlign:'center'}}> Landing </Link> */}
                <Link to="/Queue" style={{ textDecoration: 'none', color:'white', display:'block', padding:'20px', fontWeight:'bold', textAlign:'center'}}> Check Your Queue </Link>
